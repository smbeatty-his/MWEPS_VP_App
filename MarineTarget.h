#ifndef MARINE_TARGET_MODULE_H
#define MARINE_TARGET_MODULE_H
...
class MarineTarget : public ITarget
{
public:

	virtual ~MarineTarget(void);
	...
	virtual inline const char* GetClassname(void) const { return "MarineTarget"; }
	...
	ConcreteFactory(ITarget, MarineTarget)
...
typedef MarineTarget::MarineTargetFactory MarineTargetFactory;
