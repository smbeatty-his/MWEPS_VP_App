...
void define( void )
{
    ...
    pKernel_myKernel->setPriority( vuThread::PRIORITY_HIGHEST );
    pKernel_myKernel->setProcessor( 4 );
    ...
    pWindow_myWindow->setOrigin( 1600 ,  0 );
    pWindow_myWindow->setSize( 1920 ,  1080 );
    pWindow_myWindow->setFullScreenEnable( true );
    ...
    vpObject* pObject_ShipObj_2 = new vpObject();
    pObject_ShipObj_2->setName( "ShipObj_2" );
    pObject_ShipObj_2->setCullMask( 0x0FFFFFFFF );
    pObject_ShipObj_2->setRenderMask( 0x0FFFFFFFF );
    pObject_ShipObj_2->setIsectMask( 0x0FFFFFFFF );
    pObject_ShipObj_2->setStrategyEnable( true );
    pObject_ShipObj_2->setTranslate( 0 ,  0 ,  0 );
    pObject_ShipObj_2->setRotate( 0 ,  0 ,  0 );
    pObject_ShipObj_2->setScale( 1 ,  1 ,  1 );
    pObject_ShipObj_2->setStaticEnable( false );
    pObject_ShipObj_2->setFileName( "arleighburke.flt" );
    pObject_ShipObj_2->setAutoPage( vpObject::AUTO_PAGE_SYNCHRONOUS );
    pObject_ShipObj_2->setManualLODChild( -1 );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_COMBINE_LIGHT_POINTS ,  true );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_COMBINE_LODS ,  true );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_IGNORE_DOF_CONSTRAINTS ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_PRESERVE_EXTERNAL_REF_FLAGS ,  true );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_PRESERVE_GENERIC_NAMES ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_PRESERVE_GENERIC_NODES ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_PRESERVE_QUADS ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_ALL_GEOMETRIES_LIT ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_USE_MATERIAL_DIFFUSE_COLOR ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_MONOCHROME ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_CREATE_ANIMATIONS ,  true );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_SHARE_LIGHT_POINT_CONTROLS ,  true );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_SHARE_LIGHT_POINT_ANIMATIONS ,  true );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_SHARE_LIGHT_POINT_APPEARANCES ,  true );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_PRESERVE_LIGHT_SOURCES ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_PRESERVE_SURFACE_ATTRIBUTES ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_GENERATE_HIDDEN_POLYGONS ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_CREATE_BUILDINGS ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_PRESERVE_SIGNIFICANT_SIZE ,  false );
    pObject_ShipObj_2->setLoaderOption( vsNodeLoader::Data::LOADER_OPTION_PRESERVE_SURFACE_MATERIAL_CODE ,  false );
    pObject_ShipObj_2->setLoaderDetailMultiTextureStage( -1 );
    pObject_ShipObj_2->setLoaderBlendTolerance( 0.050000f );
    pObject_ShipObj_2->setLoaderUnits( vsNodeLoader::Data::LOADER_UNITS_METERS );
    pObject_ShipObj_2->setBuilderOption( vsNodeLoader::Data::BUILDER_OPTION_OPTIMIZE_GEOMETRIES ,  true );
    pObject_ShipObj_2->setBuilderOption( vsNodeLoader::Data::BUILDER_OPTION_COLLAPSE_BINDINGS ,  true );
    pObject_ShipObj_2->setBuilderOption( vsNodeLoader::Data::BUILDER_OPTION_COLLAPSE_TRIANGLE_STRIPS ,  true );
    pObject_ShipObj_2->setBuilderOption( vsNodeLoader::Data::BUILDER_OPTION_MAKE_INDEXED ,  true );
    pObject_ShipObj_2->setBuilderOption( vsNodeLoader::Data::BUILDER_OPTION_TANGENT_ORTHONORMALIZATION ,  false );
    pObject_ShipObj_2->setBuilderOption( vsNodeLoader::Data::BUILDER_OPTION_TANGENT_PARITY_CHECK ,  true );
    pObject_ShipObj_2->setBuilderOption( vsNodeLoader::Data::BUILDER_OPTION_TANGENT_HARD_EDGE_CHECK ,  true );
    pObject_ShipObj_2->setBuilderOption( vsNodeLoader::Data::BUILDER_OPTION_OPTIMIZE_SMART_MESHES ,  true );
    pObject_ShipObj_2->setBuilderNormalMode( vsNodeLoader::Data::BUILDER_NORMAL_MODE_PRESERVE );
    pObject_ShipObj_2->setBuilderTangentMode( vsNodeLoader::Data::BUILDER_TANGENT_MODE_GENERATE_PER_VERTEX_PER_PRIMITIVE_AND_ANGLE_WEIGHTED );
    pObject_ShipObj_2->setBuilderTangentGenerationMode( vsNodeLoader::Data::BUILDER_TANGENT_GENERATION_MODE_GENERATE_AS_NEEDED );
    pObject_ShipObj_2->setBuilderColorTolerance( 0.001000f );
    pObject_ShipObj_2->setBuilderNormalTolerance( 0.860000f );
    pObject_ShipObj_2->setGeometryOption( vsNodeLoader::Data::GEOMETRY_OPTION_GENERATE_DISPLAY_LISTS ,  false );
    pObject_ShipObj_2->setGeometryFormat( vrGeometryBase::FORMAT_VERTEX_BUFFER_OBJECT ,  0x0FFF );
    pObject_ShipObj_2->setPostLoadOption( vpGeometryPageable::POST_LOAD_OPTION_FLATTEN ,  true );
    pObject_ShipObj_2->setPostLoadOption( vpGeometryPageable::POST_LOAD_OPTION_CLEAN ,  true );
    pObject_ShipObj_2->setPostLoadOption( vpGeometryPageable::POST_LOAD_OPTION_MERGE_GEOMETRIES ,  true );
    pObject_ShipObj_2->setPostLoadOption( vpGeometryPageable::POST_LOAD_OPTION_COLLAPSE_BINDINGS ,  true );
    pObject_ShipObj_2->setPostLoadOption( vpGeometryPageable::POST_LOAD_OPTION_COLLAPSE_TRIANGLE_STRIPS ,  true );
    pObject_ShipObj_2->setPostLoadOption( vpGeometryPageable::POST_LOAD_OPTION_VALIDATE ,  false );
    pObject_ShipObj_2->setPostLoadOption( vpGeometryPageable::POST_LOAD_OPTION_MAKE_INDEXED ,  true );
    pObject_ShipObj_2->setPostLoadOption( vpGeometryPageable::POST_LOAD_OPTION_SCRUB ,  false );
    pObject_ShipObj_2->setTextureSubloadEnable( false );
    pObject_ShipObj_2->setBufferObjectSubloadEnable( true );
    pObject_ShipObj_2->setTextureSubloadRender( vpGeometry::TEXTURE_SUBLOAD_RENDER_DEFERRED );
    pObject_ShipObj_2->setTexturePreserveImageLevelsEnable( true );

    s_pInstancesToUnref->push_back( pObject_ShipObj_2 );
    ...
    pMarineWaveGeneratorFFT_myMarineWaveGeneratorFFT->setSeaState( 2 );
    pMarineWaveGeneratorFFT_myMarineWaveGeneratorFFT->setSurfaceWindSpeed( 5.000000f );
    pMarineWaveGeneratorFFT_myMarineWaveGeneratorFFT->setDominantWaveDirection( 265.000000f );
    pMarineWaveGeneratorFFT_myMarineWaveGeneratorFFT->setSignificantWaveHeight( 0.182880f );
    pMarineWaveGeneratorFFT_myMarineWaveGeneratorFFT->setPeakThreshold( 1.000000f );
    pMarineWaveGeneratorFFT_myMarineWaveGeneratorFFT->setTextureAnimationFactor( 1.000000f );
    ...
    pMarineWaveGeneratorFFT_myMarineWaveGeneratorFFT->setChoppyWavesFactor( 0.650000f );
    ...
    pObject_ShipObj_2->setStrategy( pMarineShipMotionStrategy_myMarineShipMotionStrategy );
